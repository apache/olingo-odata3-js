...
(function (window, undefined) {
    ...
    var verifyReadJsonLightData = function (input, expected, message, model) {
        var response = { headers: { "Content-Type": "application/json;odata=fullmetadata", DataServiceVersion: "3.0" }, body: JSON.stringify(input) };
    ...
    var verifyReadJsonLightWithMinimalMetadata = function (input, expected, message, model) {
        var response = { headers: { "Content-Type": "application/json;odata=minimalmetadata", DataServiceVersion: "3.0" }, body: JSON.stringify(input) };
    ...
    djstest.addTest(function jsonLightReadInferFeedAsObjectTest() {
        ...
        for (var name in tests) {
            ...
            OData.jsonHandler.read(response, { metadata: testModel, inferJsonLightFeedAsObject: true });
